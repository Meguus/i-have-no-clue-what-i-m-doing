G.AddData({
name:'Modified default dataset',
author:'Me, i guess',
desc:'a mod of default dataset for Legacy.',
//i am only touching what i want to change 90% of this code belongs to orteil
engineVersion:1,
manifest:0,
func:function()
{
	...
	*/
	...
	G.funcs['new game blurb']=function()
	{
		...
		G.textWithTooltip('<div class="icon freestanding" style="'+G.getIconUsedBy(G.getRes('adult'))+'"></div><div class="freelabel">x5</div>','10 Adults')+
		G.textWithTooltip('<div class="icon freestanding" style="'+G.getIconUsedBy(G.getRes('elder'))+'"></div><div class="freelabel">x1</div>','5 Elder')+
		G.textWithTooltip('<div class="icon freestanding" style="'+G.getIconUsedBy(G.getRes('child'))+'"></div><div class="freelabel">x2</div>','5 Children')+
	...
	new G.Res({
		...
		tick:function(me,tick)
		{
 //adults are now NOT part of the workforce
